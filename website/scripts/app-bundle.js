...
define('debug',["require", "exports", 'aurelia-framework', './communication'], function (require, exports, aurelia_framework_1, communication_1) {
    ...
    var NetworkSettings = (function () {
        ...
        NetworkSettings.prototype.messageReceived = function (msg) {
            this.lines.push(msg);
        };
        NetworkSettings.prototype.attached = function () {
            var _this = this;
            this.communication.subscribeDebug(function (x) { return _this.messageReceived(x); });
            this.messageReceived("attached");
        };
        NetworkSettings.prototype.detached = function () {
            var _this = this;
...
define('robot-control',["require", "exports", 'aurelia-framework', './communication'], function (require, exports, aurelia_framework_1, communication_1) {
    "use strict";
